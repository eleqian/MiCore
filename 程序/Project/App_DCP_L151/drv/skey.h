...
// 按键计时，单位ms
#define SKEY_TIME_UPDATE        (20)    // 按键状态更新间隔，需要和调用SKey_Update的周期一致
...
// 获取按键标识状态
BOOL SKey_CheckFlagAny(skey_t *skey, uint8_t flag);
BOOL SKey_CheckFlagAll(skey_t *skey, uint8_t flag);
